...
assert(blank.bundledCount == 504 and blank.overlayCount == 0
    ...
    and blank.qualifyingCount == 0 and blank.resultCount == 346
...
assert(frame._syncStatusText.text:find("504 bundled",1,true)
    and frame._syncStatusText.text:find("346 available",1,true)
...
assert(frame._syncStatusText.text:find("Listening",1,true)
    ...
    and frame._syncStatusText.text:find("20 shown of 346",1,true),
...
assert(narrowed.searchActive and narrowed.filterMatchedCount > 20
    ...
    and narrowed.availableCount == 346
...
assert(not cleared.searchActive and cleared.availableCount == 346
    and cleared.resultCount == 346 and cleared.displayedCount == 20,
...
assert(beforePublish.overlayCount == 2 and beforePublish.availableCount == 348,
...
assert(clearedTombstone.overlayCount == 1
    ...
    and clearedTombstone.availableCount == 347,
