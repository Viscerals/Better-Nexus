...
check(has(rolling,'Saving edits to the assigned Wishlist can also lead to a replacement without a new run.'),'Help: a saved edit can lead to a replacement')
check(has(rolling,'There is no separate automatic-save switch: Auto OFF stops it.'),'Help: Auto OFF is the only way to stop it')
...
local function warns(label,text)
 ...
 check(has(text,'Saving edits to the assigned Wishlist can also lead to a replacement without a new run.'),label..': a saved edit can lead to a replacement')
...
check(has(section,'Saving edits to the assigned Wishlist can also lead to a replacement without a new run.'),'guide: a saved edit can lead to a replacement')
check(has(section,'There is no separate automatic-save switch: Auto OFF stops it.'),'guide: Auto OFF is the only way to stop it')
