...
assert(#H.actions==before,'export/import draft does not spend or change permanent locks')
assert(#H.locked==6 and H.locked[1].spellId==200090,'actual ownership unchanged')
print('PASS explicit-target export/import with different permanent locks, no extra copies or actions')
