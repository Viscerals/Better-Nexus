...
check(f:IsShown() and f:GetWidth()==820 and f:GetHeight()==710,'bounded Orb window includes result reason and Close disclosure')
check(f.status:GetHeight()==92 and f.closeNotice:GetHeight()==26,'dedicated space for result reason and persistent Close disclosure')
