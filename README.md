...
- Every listed test runs from this checkout; none needs a separate project,
  archive or environment variable. A test reported as **NOT RUN** fails the
  check; it is never counted as passed.
