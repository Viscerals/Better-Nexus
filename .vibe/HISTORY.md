...
- Stage 50.2 accepted the Package B catalog authority state machine as design authority only, and Stage 50.3 implemented it on exact PR #68: one generation-bound resumable admission owner publishing a single root, collision-free typed identity, deny-only tombstone reservations with a private one-shot readmission claim, bounded cursors/indexes/status, maintenance transactions bound to the exact database, and the issue #22 semantic envelope (79 ordinary, 6 locked, 85 total) owned by LoadoutEvidence and reused at every wire boundary. Behavioral expected red was recorded on the exact base before any product edit; the candidate passes the complete Lua inventory 229/229, parse 303/303, integration 70/70, contracts 11/217/165/0, and Fast 120/120. Full on the frozen candidate and independent review remain outstanding.
- Stage 48 completed exact ordinary Wishlist tier identity, counted locked evidence, read-time ordinary/locked role derivation, and shared exact-tier progress. Independent review and Full passed at the frozen WP4 boundary; consolidation moved the active pointer to 49.1 without changing product or test bytes.
...
- ISSUE-49.1-CI-CRLF: The PR61 expected-red harness now normalizes CRLF and bare CR before exact semantic fixture isolation. LF/CRLF/CR/non-ASCII and absent/near-match/empty probes pass; all four behavioral publication-parent oracles remain red for the intended product reasons and product bytes remain unchanged. Exact-head validation, independent review, and replacement PR CI remain controller gates rather than later evidence-only Git commits.
